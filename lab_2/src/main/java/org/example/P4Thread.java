...
public class P4Thread extends Thread{
    ...
    public P4Thread(Semaphore sem, Resources resources, CyclicBarrier enteringBarrier, CyclicBarrier mainBarrier, CyclicBarrier sixthOperationBarrier) {
        this.sem = sem;
...
//sixth operation - (MA2-MB2) -> MX
        ...
        for (int i = resources.H + resources.H/2; i < resources.N; i++) {
            for (int j = 0; j < resources.N; j++) {
